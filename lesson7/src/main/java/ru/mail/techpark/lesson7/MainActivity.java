...
import ru.mail.techpark.lesson7.presentation.LoginPresenterImpl;
...
public class MainActivity extends AppCompatActivity implements LoginPresenter.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callbackSample.setValue(true);
        callbackSample.callCallback(new CallbackSample.Callback() {
            @Override
            public void logSuccess() {
                Log.d("CallbackSample", "success");
            }

            @Override
            public void logError() {
                Log.d("CallbackSample", "error");
            }
        });
    }
